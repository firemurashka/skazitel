        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (window.innerWidth > 768 && isMobile.any()) {
                    if (targetElement.classList.contains("nav__link")) targetElement.closest(".nav__item").classList.toggle("_hover");
                    if (!targetElement.closest(".nav__item") && document.querySelectorAll(".nav__item._hover").length > 0) _removeClasses(document.querySelectorAll(".nav__item._hover"), "_hover");
                }
            }
